...
NOTE: If you want to debug another test driver or anything contained you just need to add a new module with the contents of the project you want to debug.
